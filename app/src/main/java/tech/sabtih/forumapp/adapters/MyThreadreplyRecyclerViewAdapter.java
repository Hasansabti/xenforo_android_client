...
import tech.sabtih.forumapp.ThreadreplyFragment.OnListFragmentInteractionListener;
...
public class MyThreadreplyRecyclerViewAdapter extends RecyclerView.Adapter<MyThreadreplyRecyclerViewAdapter.ViewHolder> {
    ...
    public MyThreadreplyRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
