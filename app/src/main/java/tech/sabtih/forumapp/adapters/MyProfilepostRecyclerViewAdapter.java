...
import tech.sabtih.forumapp.fragments.ProfilepostFragment.OnListFragmentInteractionListener;
...
public class MyProfilepostRecyclerViewAdapter extends RecyclerView.Adapter<MyProfilepostRecyclerViewAdapter.ViewHolder> {
    ...
    public MyProfilepostRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
