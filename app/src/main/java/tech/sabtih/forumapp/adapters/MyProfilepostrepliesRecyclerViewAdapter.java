...
import tech.sabtih.forumapp.fragments.ProfilepostrepliesFragment.OnListFragmentInteractionListener;
...
public class MyProfilepostrepliesRecyclerViewAdapter extends RecyclerView.Adapter<MyProfilepostrepliesRecyclerViewAdapter.ViewHolder> {
    ...
    public MyProfilepostrepliesRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
