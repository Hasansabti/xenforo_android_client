...
import tech.sabtih.forumapp.fragments.InboxFragment.OnInboxInteractionListener;
 ...
 * specified {@link OnInboxInteractionListener}.
...
public class MyInboxRecyclerViewAdapter extends RecyclerView.Adapter<MyInboxRecyclerViewAdapter.ViewHolder> {
    ...
    private final InboxFragment.OnInboxInteractionListener mListener;

    public MyInboxRecyclerViewAdapter(List<DummyItem> items, InboxFragment.OnInboxInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
